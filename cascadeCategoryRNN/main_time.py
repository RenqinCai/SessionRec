...
parser.add_argument('--model_name', default="cascadeCategoryRNN", type=str)
...
def main():
	...
	if not args.is_eval:
		...
		network = NN4REC(log, ss, input_size, hidden_size, output_size, cate_embedding_dim=cate_embedding_dim, cate_input_size=cate_input_size, cate_output_size=cate_output_size, cate_hidden_size=cate_hidden_size,
							final_act=final_act,
