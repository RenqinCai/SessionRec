...
class Data(object):
	...
	def __init__(self, _action_file, _cate_file, _time_file, _valid_start_time, _test_start_time, _observed_threshold, _window_size):
		...
		self.m_input_seq_list_valid = []
		self.m_input_seqLen_list_valid = []

		self.m_input_cate_seq_list_valid = []

		self.m_input_subseq_list_cate_list_valid = []
		self.m_input_cate_subseq_list_cate_list_valid = []

		self.m_input_subseqLen_list_cate_list_valid = []
		self.m_input_subseqNum_seq_cate_list_valid = []
