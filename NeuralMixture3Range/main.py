...
parser.add_argument('--in_dim', type=int, default=150)
# parse the loss type
...
parser.add_argument('--model_name', default='NeuralMixture3Range', type=str)
...
def main():
	...
	if not args.is_eval:
		...
		network = M3R(log, ss, input_size, hidden_size, output_size, in_dim=in_dim,
							final_act=final_act,
