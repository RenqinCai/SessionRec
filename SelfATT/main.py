...
def main():
    ...
    if not args.is_eval:
        model = SATT(input_size, args.hidden_size, output_size, num_layers=args.num_layers, num_heads=args.num_heads, use_cuda=args.cuda,batch_size=args.batch_size, dropout_input=args.dropout_input,dropout_hidden=args.dropout_hidden,embedding_dim=args.embedding_dim,position_embedding=args.position_embedding,shared_embedding=args.shared_embedding,window_size = window_size,
        ...
        optimizer = Optimizer(model.parameters(), optimizer_type=args.optimizer_type, lr=args.lr,weight_decay=args.weight_decay, momentum=args.momentum, eps=args.eps)
