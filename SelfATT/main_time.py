...
parser.add_argument('--model_name', default="SelfATT", type=str)
...
def main():
	...
	if not args.is_eval:
		...
		network = SATT(log, ss, input_size, hidden_size, output_size,
							num_layers=num_layers,
							use_cuda=args.cuda, batch_size=args.batch_size,
