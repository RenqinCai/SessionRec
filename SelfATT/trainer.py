...
class Trainer(object):
    def __init__(self, log, model, train_data, eval_data, optim, use_cuda, loss_func, topk, sample_full_flag, input_size, args):    
        ...
        self.m_neg_sample_num = args.negative_num
    ...
    def train_epoch(self, epoch, batch_size):
        ...
        for x_short_action_batch, mask_short_action_batch, pad_x_short_action_num_batch, y_action_batch, y_action_idx_batch in dataloader:
            ...
            if self.m_sample_full_flag == "sample":
                sample_values = self.m_sampler.sample(self.m_neg_sample_num, y_action_batch)
            ...
            output_batch = self.model(x_short_action_batch)
