...
class Data(object):
	...
	def __init__(self, action_file, cate_file, time_file, observed_threshold, window_size):
		...
		self.train_dataset = Dataset(self.m_input_subseq_list_cate_list_train, self.m_input_subseqLen_list_cate_list_train, self.m_input_subseqNum_seq_cate_list_train, self.m_input_seq_list_train, self.m_input_seqLen_list_train, self.m_target_action_seq_list_train, self.m_input_seq_idx_list_train, self.m_itemFreq_map)

		self.test_dataset = Dataset(self.m_input_subseq_list_cate_list_test, self.m_input_subseqLen_list_cate_list_test, self.m_input_subseqNum_seq_cate_list_test, self.m_input_seq_list_test, self.m_input_seqLen_list_test, self.m_target_action_seq_list_test, self.m_input_seq_idx_list_test, self.m_itemFreq_map)
...
class Dataset(object):
	def __init__(self, input_subseq_list_cate_list, input_subseqLen_list_cate_list, input_subseqNum_seq_cate_list, input_seq_list, input_seqLen_list, target_action_seq_list, input_seq_idx_list, itemFreq_map):
