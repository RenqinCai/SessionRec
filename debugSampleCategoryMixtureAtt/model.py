...
class GRU4REC(nn.Module):
    ...
    def forward(self, input_cate_batch, mask_cate_batch, mask_cate_seq_batch, max_actionNum_cate_batch, max_subseqNum_cate_batch, subseqLen_cate_batch, seqLen_cate_batch, input_batch, mask_batch, seqLen_batch, train_test_flag):
        ...
        ### mask_cate_batch: batch_size*seq_len*1
        mask_cate_batch = mask_cate_batch.unsqueeze(-1)

        ### output_subseq_cate: batch_size*seq_len*hidden_size
        output_subseq_cate = output_subseq_cate*mask_cate_batch
        
        ### mask_embedded_cate: batch_size*seq_len*hidden_size
        mask_embedded_cate = embedded_cate*mask_cate_batch

        ### avg_mask_embedded_cate: batch_size*1*hidden_size
        avg_mask_embedded_cate = mask_embedded_cate.permute(0, 2, 1)

        avg_mask_embedded_cate = F.avg_pool1d(avg_mask_embedded_cate, avg_mask_embedded_cate.size(-1))
        avg_mask_embedded_cate = avg_mask_embedded_cate.permute(0, 2, 1)

        avg_mask_embedded_cate = avg_mask_embedded_cate.reshape(-1, max_subseqNum_cate_batch, output_subseq_cate.size(-1))
        ...
        input_seq_cate_skip = input_seq_cate+avg_mask_embedded_cate
        ...
        ### output_subseq_short: batch_size*seq_len*hidden_size
        output_subseq_short, hidden_subseq_shrot = self.m_short_gru(embedded_short, hidden_subseq_shrot)

        ### mask_short_batch: batch_size*seq_len*1
        mask_short_batch = mask_batch.unsqueeze(-1).float()

        ### output_subseq_short: batch_size*seq_len*hidden_size
        output_subseq_short = output_subseq_short*mask_short_batch

        avg_mask_embedded_short = embedded_short.permute(0, 2, 1)
        avg_mask_embedded_short = F.avg_pool1d(avg_mask_embedded_short, avg_mask_embedded_short.size(-1))
        avg_mask_embedded_short = avg_mask_embedded_short.permute(0, 2, 1)

        avg_mask_embedded_short = avg_mask_embedded_short.squeeze(1)
        ...
        output_short = output_short+avg_mask_embedded_short
