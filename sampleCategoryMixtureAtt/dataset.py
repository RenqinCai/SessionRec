...
class DataLoader():
	def __init__(self, dataset, batch_size, negative_sample_num):
		...
		self.m_negative_num = negative_sample_num
		print("negative num", self.m_negative_num)
		...
		temp = list(zip(input_subseqNum_seq_cate_list_batch, input_subseq_list_cate_list_batch, input_subseqLen_list_cate_list_batch, input_seq_list_batch, input_seqLen_list_batch, target_action_seq_list_batch, input_seq_idx_list_batch))

		self.m_temp = temp
		
	def __iter__(self):
		
		pop_map = dict(sorted(self.m_itemFreq_map.items(), key=lambda item: item[0]))
		pop = np.array(list(pop_map.values()))
		...
		input_subseqNum_seq_cate_list_batch, input_subseq_list_cate_list_batch, input_subseqLen_list_cate_list_batch, input_seq_list_batch, input_seqLen_list_batch, target_action_seq_list_batch, input_seq_idx_list_batch = zip(*temp)
