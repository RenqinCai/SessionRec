...
parser.add_argument('--model_name', default="CTR", type=str)
...
def main():
	...
	position_size = args.max_seq_len
	...
	if not args.is_eval:
		...
		network = CTR(log, ss, position_size, input_size, hidden_size, output_size, decay_size=hidden_size,
		num_heads = num_heads,
