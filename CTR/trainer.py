...
class Trainer(object):
    ...
    def train_epoch(self, epoch, batch_size):
        ...
        for batch_position_self_src, batch_self_src, batch_common_src, batch_common_time, batch_friend_diff_src, batch_friend_num, batch_y, batch_y_id in dataloader:
            ...
            if self.m_sample_full_flag == "sample":
                sample_values = self.m_sampler.sample(self.m_nsampled, batch_y)
            ...
            batch_position_self_src = batch_position_self_src.to(self.device)
            ...
            output_batch = self.model(batch_position_self_src, batch_self_src, batch_common_src, batch_common_time, batch_friend_diff_src, batch_friend_num, batch_friend_num_tensor)
