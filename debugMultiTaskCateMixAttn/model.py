...
class GRU4REC(nn.Module):
    def __init__(self, log, window_size, input_size, hidden_size, output_size,cate_output_size, num_layers=1, final_act='tanh', dropout_hidden=.8, dropout_input=0, batch_size=50, embedding_dim=-1, use_cuda=False, shared_embedding=True):
        ...
        self.m_cate_h2o = nn.Linear(hidden_size, cate_output_size)
    ...
    def forward(self, input_cate_batch, mask_cate_batch, mask_cate_seq_batch, max_actionNum_cate_batch, max_subseqNum_cate_batch, subseqLen_cate_batch, seqLen_cate_batch, input_batch, mask_batch, seqLen_batch, train_test_flag):
        ...
        output_subseq_cate, hidden_subseq_cate = self.m_cate_gru(embedded_cate, hidden_subseq_cate) 

        ### output_subseq_cate: batch_size*seq_len*hidden_size;
        ### hidden_subseq_cate: num_layers*batch_size*hidden_size
        ### mask_cate_batch: 1*
        ...
        ### input_seq_cate: batch_size*hidden_size for each subseq, batch_size for subseq
        input_seq_cate = output_subseq_cate[first_dim_index, second_dim_index, :]

        ### output_cate_subseq: batch_size*cate_output_size
        output_cate_subseq = self.m_cate_h2o(input_seq_cate)
        ...
        ### output_cate: batch_size*cate_output_size  
        output_cate = self.m_cate_h2o(output_short)
        ...
        return logit, output_cate_subseq, output_cate
