...
def main():
	...
	cate_output_size = len(data_obj.cates)+1
	msg = "cate_output_size: "+ str(cate_output_size)
	log.addOutput2IO(msg)

	msg = "input_size: "+str(input_size)
	log.addOutput2IO(msg)
	...
	if not args.is_eval:
		model = GRU4REC(log, window_size, input_size, hidden_size, output_size, cate_output_size,
							final_act=final_act,
