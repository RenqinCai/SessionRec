...
class Data(object):
	...
	def __init__(self, action_file, cate_file, time_file, observed_threshold, window_size):
		...
		print("valid start time", valid_start_time)
		...
		for seq_index in range(action_seq_num):
			...
			for action_index in range(actionNum_seq):
				...
				### train data
				if time_cur <= valid_start_time:
					self.addItem2train(action_index, cate_cur, window_size, action_seq_arr, cate_action_list_map_user)

				if time_cur > valid_start_time:
					if time_cur <= test_start_time:
						self.addItem2test(action_index, cate_cur, window_size, action_seq_arr, cate_action_list_map_user)
				### test data
		...
		self.train_dataset = Dataset(self.m_input_subseq_list_cate_list_train, self.m_input_subseqLen_list_cate_list_train, self.m_input_subseqNum_seq_cate_list_train, self.m_input_seq_list_train, self.m_input_seqLen_list_train, self.m_input_cate_subseq_list_cate_list_train, self.m_target_cate_seq_list_train, self.m_target_action_seq_list_train, self.m_input_seq_idx_list_train)

		self.test_dataset = Dataset(self.m_input_subseq_list_cate_list_test, self.m_input_subseqLen_list_cate_list_test, self.m_input_subseqNum_seq_cate_list_test, self.m_input_seq_list_test, self.m_input_seqLen_list_test, self.m_input_cate_subseq_list_cate_list_test, self.m_target_cate_seq_list_test,  self.m_target_action_seq_list_test, self.m_input_seq_idx_list_test)
	...
	def addItem2train(self, action_index, cate_cur, window_size, action_seq_arr, cate_action_list_map_user):
		...
		self.m_target_cate_seq_list_train.append(cate_cur)
	...
	def addItem2test(self, action_index, cate_cur, window_size, action_seq_arr, cate_action_list_map_user):
		subseq_num = 0
		...
		self.m_target_cate_seq_list_test.append(cate_cur)
...
class Dataset(object):
	def __init__(self, input_subseq_list_cate_list, input_subseqLen_list_cate_list, input_subseqNum_seq_cate_list, input_seq_list, input_seqLen_list, input_cate_subseq_list_cate_list, target_cate_seq_list, target_action_seq_list, input_seq_idx_list):
...
if __name__ == "__main__":
	...
	data_obj = Data(action_file, cate_file, time_file, observed_threshold, window_size)
