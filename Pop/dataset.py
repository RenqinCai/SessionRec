...
class Dataset(object):
    def __init__(self, itemFile, train_data_flag, sep='\t', session_key='SessionID', item_key='ItemId', time_key='timestamp', n_sample=-1, itemmap=None, itemstamp=None, time_sort=False):
