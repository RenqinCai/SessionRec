"""
process data in batch mode for seq pop and global pop
"""
...
def main():
	...
	train_data = dataset.Dataset(train_data, False)
	valid_data = dataset.Dataset(valid_data, False, itemmap=train_data.itemmap)
	test_data = dataset.Dataset(test_data, False)
	...
	if not args.is_eval:
		# network = SEQPOP(input_size)
		network = GLOBALPOP(input_size, args.cuda)
