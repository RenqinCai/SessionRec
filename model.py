...
class GRU4REC(nn.Module):
	def __init__(self, input_size, hidden_size, output_size, num_layers=1, final_act='tanh', dropout_hidden=0.5, dropout_input=0, batch_size=50, embedding_dim=-1, use_cuda=True):
	...
	def init_emb(self):
		"""
		initialize the one-hot embedding buffer, which will be used for producing the one-hot embeddings efficiently
		"""
