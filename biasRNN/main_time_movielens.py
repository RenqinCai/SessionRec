...
import pickle
import sys
from dataset_time_movielens import *
from dataset_time_movielens import _seq_corpus, _seq
...
def main():
	...
	data_obj = MYDATA(train_seq_corpus, valid_seq_corpus.m_seq_list, window_size)
