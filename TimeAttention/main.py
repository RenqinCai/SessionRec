...
def main():
    ...
    print("Loading train data from {}*.pickle".format(train_data))
    print("Loading valid data from {}*.pickle".format(valid_data))
    ...
    valid_data = Dataset(valid_data, data_name, observed_threshold, window_size, '_item.pickle', '_time.pickle', itemmap=train_data.m_itemmap)
    ...
    if not args.is_eval:
        model = TATT(input_size, args.hidden_size, output_size,
