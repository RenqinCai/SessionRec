...
def main():
	...
	train_data = "../Data/tmall/taobao_small_cate_train.pickle"
	valid_data = "../Data/tmall/taobao_small_cate_test.pickle"
	test_data = "../Data/tmall/taobao_small_cate_test.pickle"
	...
	if not args.is_eval:
		model = GRU4REC(input_size, hidden_size, output_size, final_act=final_act, num_layers=num_layers, use_cuda=args.cuda, batch_size=batch_size, dropout_input=dropout_input, dropout_hidden=dropout_hidden, embedding_dim=embedding_dim)
