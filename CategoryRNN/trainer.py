...
class Trainer(object):
    ...
    def train_epoch(self, epoch, batch_size):
        ...
        for x_cate_batch, mask_cate, max_acticonNum_cate, seqLen_cate, x_batch, mask_batch, seqLen_batch, y_batch, _ in dataloader:
            ...
            logit_batch = self.model(x_cate_batch, mask_cate, max_acticonNum_cate, seqLen_cate, x_batch, mask_batch, seqLen_batch, "train")
